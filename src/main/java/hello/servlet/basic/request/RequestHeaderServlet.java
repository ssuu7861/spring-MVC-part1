...
/*        옛날 방식
        ...
        } // hasMoreElements() : 다음 요소가 있는지 , nextElement() : 다음 요소
*/
    ...
    private void printHeaderUtils(HttpServletRequest request) {
        ...
        request.getLocales().asIterator().forEachRemaining(locale -> System.out.println("locale = " + locale)); // Accept Language 전부
        System.out.println("request.getLocale() = " + request.getLocale()); // Accept Language 1등
        System.out.println();
        ...
        System.out.println("[Content 편의 조회]"); // Message body에 담긴 Content 정보
